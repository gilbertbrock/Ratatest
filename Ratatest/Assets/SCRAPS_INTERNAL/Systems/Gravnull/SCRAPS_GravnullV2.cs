...
public class SCRAPS_GravnullV2 : MonoBehaviour {
    ...
    [SerializeField] private float pullStrength;            // How fast an object is pulled in
    private float travelSpeed = 0;
    [SerializeField] private float spinResistance;          // How fast the object will stop spinning
    [SerializeField] private float launchForce;             // How much force is added when launching the an object
    [SerializeField] private float gravRange;               // How far away the player can pickup an object
    [SerializeField] private float accuracy;                // Radius of the overlap sphere
